...
**Computation:**
```javascript
globalMerkleRoot = SHA256(
  governanceLedger.merkleRoot + consentLedger.merkleRoot
)
```
...
*This document is part of the QuantumPoly Governance Architecture (Blocks 9.0–9.3) and is maintained under version control with cryptographic integrity verification.*
