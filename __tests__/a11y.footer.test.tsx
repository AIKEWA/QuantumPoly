...
describe('A11y: Footer', () => {
  ...
  it('social links have proper labels', async () => {
    ...
    expect(getByRole('link', { name: /^GitHub\b/i })).toBeInTheDocument();
    expect(getByRole('link', { name: /^Twitter\b/i })).toBeInTheDocument();
    expect(getByRole('link', { name: /^LinkedIn\b/i })).toBeInTheDocument();
  });
