...
describe('About Component', () => {
  ...
  it('renders all user-visible text from props', () => {
    ...
    expect(screen.getByText('We are leading the future of quantum computing and decentralized technologies.')).toBeInTheDocument();
  });
  ...
  it('links body content via aria-describedby', () => {
    ...
    expect(bodyElement).toHaveTextContent('We are leading the future of quantum computing and decentralized technologies.');
  });
