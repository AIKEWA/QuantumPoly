 ...
 */
function validateLocaleDirectory(locale) {
 ...
 */
function validateRequiredFiles(locale) {
    const results = [];
    const localePath = path.join(LOCALES_DIR, locale);
 ...
 */
function validateJsonSyntax(locale, file) {
 ...
 */
function validateKeys(referenceLocale, targetLocale, file) {
    const results = [];
