...
```json
{
  ...
  "insights": [
    { "insight_id": "eii-decline-a3f2b8c1", "severity": "moderate" }
  ],
...
```json
{
  ...
  "latest_entry": { /* latest entry metadata */ },
...
```json
{
  ...
  "trust_trajectory": { /* TTI data */ },
  "statistical_analysis": { /* full analysis */ },
  "ml_analysis": null
}
```
...
**Mitigation:**
- Recommendations explicitly label responsible *roles*, not individuals
