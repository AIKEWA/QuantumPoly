/**
 * @fileoverview Centralized Integrity Type Definitions
 * @module types/integrity
 * @see FPP-05.1
 *
 * Centralized type definitions for the continuous integrity monitoring,
 * EII metrics, and consent framework.
 */
