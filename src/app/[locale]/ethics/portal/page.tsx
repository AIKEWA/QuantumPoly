...
export const metadata: Metadata = {
  ...
  description: "Public transparency portal for governance ledger, audit status, and integrity proofs",
  robots: "index, follow",
  openGraph: {
    title: "Ethics Portal - QuantumPoly",
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        ...
        <section className="mb-12">
          ...
          {monitoringSummary.available ? (
            <div className="grid gap-6 lg:grid-cols-2">
              <SystemHealthCard
                systemState={monitoringSummary.system_state as 'healthy' | 'warning' | 'degraded' | 'unknown'}
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-8 text-center dark:border-gray-700 dark:bg-gray-800">
              <p className="text-gray-500 dark:text-gray-400">
                Monitoring data not yet available. System monitoring begins after first autonomous check.
              </p>
            </div>
          )}
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              ...
              <div className="text-2xl font-bold text-gray-900 dark:text-gray-100" aria-label={`Latest block: ${latest}`}>
                {latest}
              </div>
              <div className="mt-2 text-xs text-gray-500 dark:text-gray-500">
        ...
        <section className="mb-12 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="mt-4 rounded-lg bg-blue-50 p-4 text-sm text-blue-800 dark:bg-blue-900/20 dark:text-blue-300">
            ...
            <p className="mt-1">
              ...
              <Link href="/docs/transparency" className="underline hover:text-blue-900 dark:hover:text-blue-200">
        ...
        <footer className="border-t border-gray-200 pt-8 text-center dark:border-gray-700">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600 dark:text-gray-400">
            <Link href="/en/governance" className="hover:text-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 dark:hover:text-cyan-400">
              Governance Overview
            </Link>
            <span aria-hidden="true">•</span>
            <Link href="/en/privacy" className="hover:text-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 dark:hover:text-cyan-400">
              Privacy Policy
            </Link>
            <span aria-hidden="true">•</span>
            <Link href="/en/contact" className="hover:text-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 dark:hover:text-cyan-400">
              Contact
            </Link>
          </div>
        </footer>
