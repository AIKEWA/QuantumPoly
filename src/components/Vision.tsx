...
const defaultPillars: VisionPillar[] = [
  ...
  {
    icon: '🕶️',
    title: t('pillars.metaverse.title'),
    description: t('pillars.metaverse.description'),
  },
];
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div className="sr-only" aria-live="polite">
          End of vision pillars section. {pillars.length} pillars displayed.
        </div>
      </div>
    </section>
  );
