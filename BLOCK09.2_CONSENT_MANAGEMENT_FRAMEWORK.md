...
├── BLOCK09.2_CONSENT_MANAGEMENT_FRAMEWORK.md (this file)
...
_This document is part of the QuantumPoly governance framework and is subject to regular review and updates. For the latest version, consult the governance ledger._
